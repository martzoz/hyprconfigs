...
ShellRoot {
    ...
    Variants {
        ...
        PanelWindow {
                ...
                HudPanel {
                    ...
                    Column {
                        ...
                        Row {
                            ...
                            Text { text:"UNIT: "+root.hostname.toUpperCase(); font.family:"Share Tech Mono"; font.pixelSize:9; font.letterSpacing:1.5; font.weight:Font.Medium; color:root.inkSoft; opacity:0.5; width:parent.parent.width/2 }
                            Text { text:"UP: "+root.uptime.toUpperCase(); font.family:"Share Tech Mono"; font.pixelSize:9; font.letterSpacing:1.5; font.weight:Font.Medium; color:root.inkSoft; opacity:0.5 }
                        }
                    }
                }
                Rectangle {
            ...
            SequentialAnimation {
                id: hide1
                // Curtain sweeps in right→left, then panel slides left off screen
                onStarted: { curtain1.x = 0; curtain1.width = wipe1.width }
            ...
            SequentialAnimation {
                id: reveal3
                // Set position and curtain BEFORE visible to prevent jitter flash
                onStarted: { wipe3.x = 120-wipe3.width-2; curtain3.x = 0; curtain3.width = wipe3.width; wipe3.visible = true }
            ...
            SequentialAnimation {
                id: hide3
                // Curtain sweeps in right→left, then panel slides left off screen
                onStarted: { curtain3.x = 0; curtain3.width = wipe3.width }
